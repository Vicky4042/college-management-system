...
import {BookOpen, Clock, Users, Calendar, GraduationCap, MapPin, AlertCircle} from 'lucide-react'
    ...
    courseService.getAllCourses,
    {
      onError: (error: any) => {
        toast({
          ...
          description: error.response?.data?.message || 'Unable to fetch course information',
          variant: 'destructive'
        })
      }
    }
    ...
    return (
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">Browse all available courses and their detailed particulars.</p>
        </div>
        ...
        <Card>
          <CardContent className="py-8">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">Unable to fetch course information. Please try again later.</p>
            </div>
          </CardContent>
        </Card>
      </div>
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {courses.reduce((total, course) => total + (course.maxCapacity - course.enrolledStudents), 0)}
            </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center text-sm">
                  ...
                  <span className="ml-1">{course.enrolledStudents}/{course.maxCapacity} Students</span>
                </div>
              </div>
